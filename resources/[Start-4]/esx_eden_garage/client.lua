...
function OpenMenuGarage()
	...
	local elements = {
		...
		{label = "Store your vehicle", value = 'stock_vehicle'},
		{label = "Replace lost or stolen vehicle ("..Config.Price.."$)", value = 'return_vehicle'},
	}
...
AddEventHandler('eden_garage:hasEnteredMarker', function(zone)
	if zone == 'garage' then
		...
		CurrentActionMsg  = "Press ~INPUT_PICKUP~ to open the garage | Park your vehicle in the RED Circle to store."
		CurrentActionData = {}
	end
end)
